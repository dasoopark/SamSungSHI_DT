...
namespace MyFirstCSharp
{
    public partial class Chap26_2sComplement_2의_보수법_ : Form
    {
        ...
        private void btnint_Click(object sender, EventArgs e)
        {
            ...
            //int의 경우 최소 값 에서 증가 한 정수의 수로 확인하므로.
            // 0011 0001 0001 1001 1010 0100 1110 0001 : 823731425 만큼 증가 했다고 판단.

            // -2147483648 + 823731425 = 1,323,752,223

            // 양수와 음수를 표현하는 2의 보수 법
            // 부호(양수/음수)가 있는 숫자 자료 형에서 2진수 데이터를 음수로 변환하는 알고리즘.
            
            // ex) int 의 최대 값인 2147483647 을 2의 보수법으로 int 가 인식하는 음수 2진수로 만들어보자
